...
void VulkanSetup::printLayers()
{
	...
	PRINT("Available Intance Layers: (%u)\n", layerCount)
...
void VulkanSetup::printExtensions()
{
	...
	PRINT("Available Intance Extensions: (%u)\n", extensionCount)
...
VulkanSetup::VulkanSetup(const char* _appNAme, const char* _engineName, const char* _libName, FILE* _logfile)
{
    ...
    GET_FCN_PTR(vkCreateDescriptorPool)
    GET_FCN_PTR(vkCmdPushConstants)
    GET_FCN_PTR(vkCreateSampler)
    GET_FCN_PTR(vkCreateShaderModule)
    GET_FCN_PTR(vkCreatePipelineLayout)
    GET_FCN_PTR(vkCreateGraphicsPipelines)
    GET_FCN_PTR(vkAllocateDescriptorSets)
    GET_FCN_PTR(vkUpdateDescriptorSets)
...
void TextOverlay::addText(char* text, float x, float y)
{
